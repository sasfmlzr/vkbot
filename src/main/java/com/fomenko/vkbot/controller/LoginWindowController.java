...
public class LoginWindowController implements Initializable
{
	...
	final static String resourcePath = "com.fomenko.vkbot.resourcebundle.LoginWindow.messages";
	final static String fxmlPath = "/com/fomenko/vkbot/views/LoginWindow.fxml";
