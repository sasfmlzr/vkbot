...
{
	public final static String resourcePath = "com.fomenko.vkbot.resourcebundle.AboutProgramWindow.messages";
	...
	public void initWindow() throws IOException {
		...
		textLog.setText("");
		BufferedReader bReader = new BufferedReader(new FileReader("/com/fomenko/vkbot/resourcebundle/AboutProgramWindow/About.txt"));
