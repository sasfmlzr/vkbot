...
open class Messages(client: BotApiClient) : AbstractAction(client) {
    ...
    fun vkSendMessage(actor: UserActor, message: String, messagesList: List<Dialog>) {
    ...
    @Throws(ClientException::class, ApiException::class)
    fun vksendImageMessages(actor: UserActor, messagesList: List<Dialog>) {
        com.sasfmlzr.apivk.functions.message.Messages(client.vkApiClient)
    ...
    @Throws(ClientException::class, ApiException::class)
    fun vkSendMessage(actor: GroupActor, message: String, messagesList: List<Dialog>) {
        com.sasfmlzr.apivk.functions.message.Messages(client.vkApiClient)
            .vkSendMessage(actor, message, messagesList, super.client.vkApiClient)
    }

    @Throws(ClientException::class, ApiException::class)
    fun vksendImageMessages(actor: GroupActor, messagesList: List<Dialog>) {
        com.sasfmlzr.apivk.functions.message.Messages(client.vkApiClient)
            .vksendImageMessages(actor, messagesList, super.client.vkApiClient)
    }
